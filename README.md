...
| **Decrypt from Compose** | Restores the original body and reverts `.pgp` attachments on a message you've already encrypted, so recipients, body, or attachments can be edited before re-encrypting |
